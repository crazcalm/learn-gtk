...
class LabelWindow(Gtk.Window):
    def __init__(self):
        ...
        label = Gtk.Label("This is a example of a line-wrapped, filled label."
                          "It should be taking "
                          ...
                          "paragraph. It is comig to an end, "
                          "unfortunately.")
        label.set_line_wrap(True)
        ...
        label.set_markup("Text can be <small>small</small>, <big>big</big>, "
                         ...
                         "title=\"Clicked to find out more\">internets</a>.")
        label.set_line_wrap(True)
        vbox_left.pack_start(label, True, True, 0)
        ...
        button = Gtk.Button(label="Click at you own risk")
