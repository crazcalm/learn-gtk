...
class ComboBoxWindow(Gtk.Window):
    def __init__(self):
        ...
        countries = ["Austria", "Brazil", "Belgium", "France", "Gemany",
            "Switzerland", "United Kindom", "United States", "Uruguay"]
        ...
        currencies = ["Euro", "US Dollar", "British pound", "Japanese Yen",
    ...
    def on_country_combo_changed(self, combo):
        ...
        if tree_iter != None:
            ...
            print("Slected: country={}".format(country))

    def on_currency_combo_changed(self, combo):
        text = combo.get_active_text()
        if text != None:
            print("Slected: country={}".format(text))
